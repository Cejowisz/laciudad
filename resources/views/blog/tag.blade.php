        ...
        <div class="row">
            <div class="col s12 m9 l9">
                <div class="row">
                    ...
                    {!! $tag->posts()->count() == 0 ? "<h4>There is no Post associated with this tag</h4>" : ""!!}
                    @foreach($tag->posts as $post)
                        <div class="col col m6 l6">
                            <div class="blog-post">
                                <a href="{{ route('blog.single', $post->slug) }}"><img src="{{ asset('uploads') }}/{{ $post->featured_image }}" class="responsive-img" alt="InfoAffair Image"></a>
                ...
                {{--{{ $tag->posts()->paginate(2) }} to use it later when big --}}
